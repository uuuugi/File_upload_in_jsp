...
/* 			if (item.isFormField()) {// 전송할때 file외에 다른 일반요소(EX>text)도 전송하였을 경우 
			...
			out.print(fieldName + " : <a href='filedown.jsp?fileName=" + encodeName + "'>" + fileName + "</a><br>"); 
			// 다운로드 링크 출력 클릭시 filedown.jsp를 통해 파일을 다운로드 한다.
